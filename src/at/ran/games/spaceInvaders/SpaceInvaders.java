...
import at.ran.games.spaceInvaders.Ellipse;
import at.ran.games.spaceInvaders.Rectangle;
import at.ran.games.spaceInvaders.Rocket;
import at.ran.games.spaceInvaders.*;
...
*/
    ...
    public void keyPressed(int key, char c) {
      if(key == Input.KEY_SPACE){
          ...
          at.ran.games.spaceInvaders.Cannonball cb =  new Cannonball(this.rocket.getX(), this.rocket.getY());
